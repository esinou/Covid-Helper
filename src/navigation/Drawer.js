...
import Dashboard from '../screens/Statistiques';
import Messages from '../screens/Pays';
import Contact from '../screens/Symptomes';
            ...
            <Block>
                <Block flex={0.4} margin={20} bottom>
                    ...
                    <DrawerItem
                        ...
                        icon={() => <AntDesign name="eye" color="white" size={16} />}
                    />
                    <DrawerItem
                    ...
                    <DrawerItem
                        ...
                        icon={() => <AntDesign name="warning" color="white" size={16} />}
                    />
                </Block>
            </Block>
...
export default () => {
    ...
    return (
        <LinearGradient style={{ flex: 1 }} colors={[colors.green3, colors.green1]}>
            <Drawer.Navigator
                // hideStatusBar
                drawerType="slide"
